  ...
  .ports = {
    {
      .port = IOPORT1,  // PORTA
      .pads = {
        /* PTA0*/ PAL_MODE_ALTERNATIVE_7,   /* PTA1*/ PAL_MODE_ALTERNATIVE_2,   /* PTA2*/ PAL_MODE_ALTERNATIVE_2,  // SWD_CLK, MCU_RX, MCU_TX
        /* PTA3*/ PAL_MODE_ALTERNATIVE_7,   /* PTA4*/ PAL_MODE_OUTPUT_PUSHPULL, /* PTA5*/ PAL_MODE_UNCONNECTED,    // SWD_DIO, LED, NC
        ...
        /*PTA18*/ PAL_MODE_INPUT_ANALOG,    /*PTA19*/ PAL_MODE_INPUT_ANALOG,    /*PTA20*/ PAL_MODE_UNCONNECTED,    // XTAL, EXTAL, NC
    ...
    },
    {
      .port = IOPORT2,  // PORTB
      .pads = {
        /* PTB0*/ PAL_MODE_OUTPUT_PUSHPULL, /* PTB1*/ PAL_MODE_INPUT,           /* PTB2*/ PAL_MODE_UNCONNECTED,   // FPGA_DRIVE, MCU_F_INIT, NC
    ...
    },
    {
      .port = IOPORT3,  // PORTC
      .pads = {
        /* PTC0*/ PAL_MODE_UNCONNECTED,     /* PTC1*/ PAL_MODE_OUTPUT_PUSHPULL, /* PTC2*/ PAL_MODE_INPUT,         // NC, MCU_F_PROG, MCU_F_DONE
        /* PTC3*/ PAL_MODE_OUTPUT_PUSHPULL, /* PTC4*/ PAL_MODE_INPUT,           /* PTC5*/ PAL_MODE_INPUT,         // MCU_F_MODE, MCU_SPI_CS (NC at boot), MCU_SCK (NC at boot)
        /* PTC6*/ PAL_MODE_INPUT,           /* PTC7*/ PAL_MODE_INPUT,           /* PTC8*/ PAL_MODE_UNCONNECTED,   // MCU_SPI_MOSI, MCU_SPI_MISO, NC
